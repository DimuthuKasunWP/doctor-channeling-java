...
public class RemoveSchedulePanel extends javax.swing.JPanel {
    ...
    private void loadScheduleID(){
        ...
        try {
            ...
            Logger.getLogger(RemoveSchedulePanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        lblTopic.setText("Remove Schedule ");
        ...
        txtDayName.setFocusable(false);

        txtTimeSlot.setFocusable(false);

        txtMaxPatientCount.setFocusable(false);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
       String scheduleID=(String) cmbScheduleId.getSelectedItem();
        ...
        try {
            boolean result=ctrlSchedule.delete(scheduleID);
            if (result){
                JOptionPane.showMessageDialog(this, "Schedule has been successfully Deleted...!");
            }else{
                JOptionPane.showMessageDialog(this, "Schedule has not been Deleted...!");
            }
        } catch (Exception ex) {
            Logger.getLogger(RemoveSchedulePanel.class.getName()).log(Level.SEVERE, null, ex);
        }
