 ...
 */
public class AddNewHospitalPanel1 extends javax.swing.JPanel {
    private HospitalController ctrlHospital;

    /**
     * Creates new form AddNewDoctorPanel
     */
    public AddNewHospitalPanel1() {
        initComponents();
    ...
    public void genarateHospitalID(){
        try {
            ...
            Logger.getLogger(AddNewHospitalPanel1.class.getName()).log(Level.SEVERE, null, ex);
