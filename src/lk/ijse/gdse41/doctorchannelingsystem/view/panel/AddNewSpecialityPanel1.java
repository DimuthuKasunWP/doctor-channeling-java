 ...
 */
public class AddNewSpecialityPanel1 extends javax.swing.JPanel {
    private SpecialityController ctrlSpeciality;

    /**
     * Creates new form AddNewDoctorPanel
     */
    public AddNewSpecialityPanel1() {
        initComponents();
    ...
    public void genarateSpecialityID(){
        try {
            ...
            Logger.getLogger(AddNewSpecialityPanel1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        lblSpType = new javax.swing.JLabel();
        ...
        lblSpID.setText("Speciality ID :");

        lblSpType.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lblSpType.setText("Speciality Type :");
    ...
    private javax.swing.JLabel lblSpType;
